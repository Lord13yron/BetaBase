...
//   function handleRevoke(userId: string, gymId: number, username: string) {
//     if (!confirm(`Revoke admin access for @${username}?`)) return;
//     startTransition(async () => {
//       const result = await revokeGymAdmin(userId, gymId);
...
//                   <button
//                     onClick={() =>
//                       handleRevoke(admin.user_id, admin.gym_id, admin.username)
//                     }
//                     disabled={isPending}
